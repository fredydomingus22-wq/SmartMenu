...
function TableSetter({ tableId }: { tableId?: string }) {
    ...
    }, [tableId, setTableId, setOrderType]);
    return null;
}
...
export function MenuLayoutClient({
    ...
    const brandingStyles = useMemo(() => {
        ...
        if (branding.borderRadius) styles['--radius'] = branding.borderRadius;
