-- FIX: Drop existing tables to allow a clean migration if partially applied
-- CAUTION: This will delete existing data in these tables. 
-- Since we are in development and changing the entire hierarchy structure, this is often the cleanest way.
...
-- Now include the full migration
-- CreateSchema
...
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('OWNER', 'MANAGER', 'WAITER', 'KITCHEN');
